...
public class AdminViewReceptionistj extends javax.swing.JInternalFrame {
    ...
    public AdminViewReceptionistj(Color panelBackgroundColor, Color fontBorderColor) {
    ...
    private void initComponents() {
        ...
        setBackground(this.getFontBorderColor());
        ...
        jButton4.setText("Force To Reset Password");
        jButton4.setPreferredSize(new java.awt.Dimension(331, 45));
    ...
    public void addChanges(String appendToEnd) {
        ...
        try {
            ...
            writeFileObj.WriteInFile(new Receptionist(staffId, staffEmailAddress,
                    ...
                    password, DOB, profilePic, dateOfJoin, staffPhoto, attachDoc).toString() + appendToEnd,
