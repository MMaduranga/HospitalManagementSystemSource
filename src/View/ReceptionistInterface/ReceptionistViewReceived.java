...
public class ReceptionistViewReceived extends javax.swing.JInternalFrame {
    ...
    public ReceptionistViewReceived(Color panelBackgroundColor, Color fontBorderColor) {
    ...
    public void addChanges() {
        ...
        try {
            ...
            new WriteFile().WriteInFile(new ReceivedPostalMail(referenceNo, currentDate,
                    attachDoc, note, fromName, fromAddress, toName).toString(),
