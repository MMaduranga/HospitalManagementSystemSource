...
public class PatientAddComplaint extends javax.swing.JInternalFrame {
    ...
    public PatientAddComplaint(String patientDetails, Color panelBackgroundColor, Color fontBorderColor) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            new WriteFile().WriteInFile(new ComplaintRecord(complaintType, complaintBy,
                    PhoneNo, currentDate, description, actionTaken, note, attachDoc).toString(),
