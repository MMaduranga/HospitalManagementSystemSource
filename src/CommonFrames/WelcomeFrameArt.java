...
public class WelcomeFrameArt extends javax.swing.JInternalFrame {

    public WelcomeFrameArt() {
        initComponents();
    ...
    public void setImage() {
        ImageIcon welcomeFrameArt = new ImageIcon("src\\CommonFrames\\doctor1.jpg");
