...
public class PatientAddAppointment extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form PatAddAppoinment
     */
    public PatientAddAppointment() {
        initComponents();
        //remove help buutton background and border
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Doctor", "Doctor1", "Doctor2", "Doctor3" }));
        ...
        jSpinner2.setMinimumSize(new java.awt.Dimension(100, 37));
        ...
        jSpinner3.setMinimumSize(new java.awt.Dimension(100, 37));
...
public void handleDropdownListItem() {
       ...
       new SimpleMethods().addItemsToDropdown(new ReadFile().getItemsForDropdownList
        (new File("src\\TxtFiles\\SpecialistArea.mov")), jComboBox1);
   
    }
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String patient = jTextField1.getText().toLowerCase();
        ...
        String appointmentRecordStatus = "pending";
        int appointmentNo = 0;
